...
from utils import instantiate_from_config, save_sample_img
...
class Net2NetTransformer(nn.Module):
    ...
    def set_device(self, device):
        ...
        self.permuter = self.permuter.to(self.device)
    ...
    def forward(self, x, c):
        ...
        _, c_indices = self.encode_to_i(c)
    ...
    @torch.no_grad()
    def encode_to_i(self, c):
        quant_z, _, info = self.cond_stage_model.encode(c)
        indices = info[2].view(quant_z.shape[0], -1)
        indices = self.permuter(indices)
        return quant_z, indices
    ...
    def log_images(self, batch, temperature=None, top_k=None, callback=None, lr_interface=False, **kwargs):
        ...
        quant_c, c_indices = self.encode_to_i(c)
    ...
    def validation_step(self, batch, batch_idx, save_config):
        ...
        if batch_idx == 0:
            ...
            save_sample_img(log, save_config)
