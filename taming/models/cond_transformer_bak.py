...
class Net2NetTransformer(nn.Module):
    ...
    def init_cond_stage_from_ckpt(self, config):
        ...
        for name, param in self.cond_stage_model.named_parameters():
            if 'quantize.embedding.weight' in name:
                param.requires_grad = False
                print('Cond_stage_model model freeze VectorQuantizer')
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.Adam(list(self.cond_stage_model.encoder.parameters())+
                                      list(self.cond_stage_model.quant_conv.parameters()),
                                      lr=lr, betas=(0.5, 0.9))
